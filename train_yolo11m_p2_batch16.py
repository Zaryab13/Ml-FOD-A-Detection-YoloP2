"""
YOLOv11m-P2 Training Script - BATCH 16 (Fair Comparison)
Trains YOLOv11m with P2 detection head on FOD-A dataset at batch 16 for fair comparison.
...
RUN_NAME = f"yolo11m-p2_batch16_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
...
def train_yolo11m_p2_batch16():
    """Train YOLOv11m-P2 model at batch 16"""
    
    print("="*70)
    print("YOLOv11m-P2 TRAINING (BATCH 16 - FAIR COMPARISON)")
    print("="*70)
    ...
    print(f"   Model: YOLOv11m-P2 (P2/P3/P4/P5 detection heads)")
    ...
    print("   • +0.8-2.0% mAP improvement expected\n")
    ...
    print("\n📊 Comparison:")
    print("   Previous (batch=6): 90.62% mAP@50-95")
    print("   Current (batch=16): Check results.csv for final score")
    print("   Expected: 91.4-92.6% mAP@50-95\n")
...
if __name__ == "__main__":
    try:
        print("\n" + "="*70)
        print("YOLOv11m-P2 RETRAINING - FAIR COMPARISON (BATCH 16)")
        print("="*70)
        ...
        model, results = train_yolo11m_p2_batch16()
